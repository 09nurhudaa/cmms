...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <form id="form1" method="get" action="<?php echo base_url('Laporan/GetLaporanPerawatan') ?>">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Laporan Data Perawatan</h3>
        </div>
        <div class="box-body">
          <table class="table table-bordered">
            <thead class="bg-primary">
              <tr>
                ...
                <th style="text-align: center;">Waktu Perawatan</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;"><?php echo $laporan->kode_perawatan ?></td>
                <td style="text-align: center;"><?php echo $laporan->jenis_perawatan ?></td>
                ...
                <td style="text-align: center;"><?php echo $laporan->tanggal ?></td>
                 <td><?php if ($laporan->keterangan == "Belum") {
                          ...
                          echo $date1 = date('d-m-Y H:i:s' , strtotime($laporan->waktu_perawatan));
       ...
       <a href="<?php echo base_url('Laporan/LaporanPerawatanCetak?startdate='.$startdate.'&enddate='.$enddate) ?>" target=_blank><button class="btn btn-success btn-sm fa fa-print"> Cetak Data</button></a>
    </div>
  </div>
</section>